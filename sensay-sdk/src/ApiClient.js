...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.sensay.io') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.sensay.io
         */
        ...
        this.authentications = {
            'OrganizationServiceToken': {type: 'apiKey', 'in': 'header', name: 'X-ORGANIZATION-SECRET'},
	...
	/**
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2025-03-25/Javascript'
        };
